...
RSpec.describe Services::WorkerTaskRequestRemoteParseTasksGenerate do
  ...
  it 'do nothing if no genre found' do
    Services::WorkerTaskRequestRemoteParseTasksGenerate.new.call
  ...
  describe 'respond state to caller' do
    it 'return false when execution failed' do
      expect(Services::WorkerTaskRequestRemoteParseTasksGenerate.new.call).to eq false
    end
    ...
    it 'return true when execution successful' do
      ...
      book_with_date
      remote_parse_goal_with_actual_date
      expect(Services::WorkerTaskRequestRemoteParseTasksGenerate.new.call).to eq true
    end
  end
end
